...
use super::common::{quick_escape, format_address_paragraphs_xml, GenerateNakazZvilnennyaRequest};

#[tauri::command]
pub fn generate_nakaz_zvilnennya_docx(req: GenerateNakazZvilnennyaRequest) -> Result<String, String> {
    if req.workers.is_empty() {
        return Err("Оберіть хоча б одного працівника для звільнення з роботи".to_string());
    }

    let nakaz_clean = req.nakaz_num.trim();
    let filename = if req.workers.len() == 1 {
        let initials_clean = req.workers[0].worker_initials.trim();
        format!("Наказ {} звільнення {}.docx", nakaz_clean, initials_clean)
    } else {
        format!("Наказ {} звільнення працівників.docx", nakaz_clean)
    };
...
<w:styles xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main">
  <w:docDefaults>
    ...
    let dismissal_date_esc = quick_escape(&req.workers[0].dismissal_date_str);
    ...
    if req.workers.len() == 1 {
        ...
        body_clauses_xml.push_str(&format!(
            r#"<w:p><w:pPr><w:jc w:val="both"/><w:spacing w:before="0" w:after="0" w:line="240" w:lineRule="auto"/><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr></w:pPr><w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr><w:t xml:space="preserve">1. {}, звільнити за угодою сторін, з посади {} від {} відповідно до ст. 36 КЗпП України.</w:t></w:r></w:p>
<w:p><w:pPr><w:spacing w:before="0" w:after="0" w:line="240" w:lineRule="auto"/></w:pPr></w:p>
<w:p><w:pPr><w:jc w:val="both"/><w:spacing w:before="0" w:after="0" w:line="240" w:lineRule="auto"/><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr></w:pPr><w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr><w:t xml:space="preserve">2. Провести остаточний розрахунок з {} та виплатити компенсацію за всі дні невикористаної відпустки.</w:t></w:r></w:p>"#,
            worker_acc_esc, position_esc, dismissal_date_esc, worker_initials_esc
        ));
        ...
        body_clauses_xml.push_str(&format!(
            r#"<w:p><w:pPr><w:jc w:val="both"/><w:spacing w:before="0" w:after="0" w:line="240" w:lineRule="auto"/><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr></w:pPr><w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr><w:t xml:space="preserve">1. Звільнити з роботи від {} наступних працівників:</w:t></w:r></w:p>"#,
            dismissal_date_esc
        ));
        ...
        for (idx, w) in req.workers.iter().enumerate() {
            ...
            body_clauses_xml.push_str(&format!(
                r#"<w:p><w:pPr><w:jc w:val="both"/><w:spacing w:before="0" w:after="0" w:line="240" w:lineRule="auto"/><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr></w:pPr><w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr><w:t xml:space="preserve">1.{}. {}, звільнити за угодою сторін, з посади {} відповідно до ст. 36 КЗпП України.</w:t></w:r></w:p>"#,
                idx + 1, worker_acc_esc, position_esc
            ));
        }

        body_clauses_xml.push_str(
            r#"<w:p><w:pPr><w:spacing w:before="0" w:after="0" w:line="240" w:lineRule="auto"/></w:pPr></w:p>
<w:p><w:pPr><w:jc w:val="both"/><w:spacing w:before="0" w:after="0" w:line="240" w:lineRule="auto"/><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr></w:pPr><w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="24"/><w:szCs w:val="24"/></w:rPr><w:t xml:space="preserve">2. Провести остаточний розрахунок з працівниками та виплатити компенсацію за всі дні невикористаної відпустки.</w:t></w:r></w:p>"#,
        );
...
<w:p><w:pPr><w:spacing w:before="0" w:after="0" w:line="240" w:lineRule="auto"/></w:pPr></w:p>
<w:p><w:pPr><w:jc w:val="center"/><w:spacing w:before="0" w:after="0" w:line="240" w:lineRule="auto"/><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:b/><w:sz w:val="28"/><w:szCs w:val="28"/></w:rPr></w:pPr><w:r><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:b/><w:sz w:val="28"/><w:szCs w:val="28"/></w:rPr><w:t>ПРО ЗВІЛЬНЕННЯ З РОБОТИ</w:t></w:r></w:p>
<w:p><w:pPr><w:spacing w:before="0" w:after="0" w:line="240" w:lineRule="auto"/></w:pPr></w:p>

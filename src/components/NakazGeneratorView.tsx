...
import { FopData, Munkas, NakazFileItem, Cim } from "../types/fop";
import {
...
import {
  getWorkerAccusativeName,
  getWorkerDativeName,
  getWorkerInitials,
  formatUkrainianDate,
  formatDotDateWithZeros,
} from "../utils/ukrainianDeclension";
...
export type NakazTypeKey = "priyom" | "zvilnennya" | "vidpustka" | "premiya";
    ...
    <div className="flex flex-col gap-6 animate-fadeIn pb-16 w-full font-sans text-slate-800">
      ...
      <div className="bg-white rounded-[24px] p-5 border-2 border-[#cbd8d6] shadow-md flex flex-col lg:flex-row items-center justify-between gap-5 relative z-30">
        ...
        <div className="flex items-center gap-4 w-full lg:w-auto">
          ...
          {/* CUSTOM DROPDOWN 2: WORKER SELECTOR */}
